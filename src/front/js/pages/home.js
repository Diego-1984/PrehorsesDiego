				...
				<div className="container-fluid">
					<div className="row d-flex">
						<div className="col text-start m-5 pt-5 ps-5">
							...
							<h5 className="text-white mb-4 ms-5 pt-3">Tu página de compra-venta de caballos Pura Raza Español</h5>
							<figure className="mt-5">
								<blockquote className="blockquote ms-5 ps-3">
									<p className="text-warning text-center" style={{width: 30 + 'rem'}}><em>"De mi caballo aprendí que la fuerza se complementa con la nobleza y la lealtad"</em></p>
								</blockquote>
