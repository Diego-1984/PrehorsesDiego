      ...
      <div className="row mx-2 my-2">
        <Link to="/">
          <button className="bg-transparent border border-0">
            Home / Caballos / Descripción
          </button>
        </Link>
      </div>
      <div className="container oneHorse">
        <div className="datosCaballo" style={datosCaballoSinChat}>
          <div className="card mt-3 border-0">
            ...
            <div className="row">
              <div className="col mt-3">
                ...
                <div className="d-flex descriptionIcons w-50">
                  <span className="material-symbols-outlined me-3">cake</span>
              ...
              <div className="col mt-3">
                ...
                <div className="d-flex w-50 descriptionIcons">
                  <span className="material-symbols-outlined me-3">map</span>
              ...
              <div className="col p-0 mt-3">
                ...
                <div className="d-flex descriptionIcons">
                  <span className="material-symbols-outlined me-3">height</span>
              ...
              <div className="col p-0 mt-3">
                ...
                <div className="d-flex descriptionIcons">
                  <span className="material-symbols-outlined me-3">fence</span>
