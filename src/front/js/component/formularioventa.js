...
const FormularioVenta = () => {
    return(
        <div className="container mt-1 border 1 rounded bg-black text-white">
            ...
            <form className="row g-3">
                <div className="col-md-3">
                    ...
                    <input type="text" className="form-control" id="validationDefault01" required
                        placeholder="Nombre del caballo" onChange={()=>{}}/>
                </div>
                <div className="col-md-2">
                    <label htmlFor="validationDefault02" className="form-label"><strong>Fecha de nacimiento</strong></label>
                    <input type="datetime" className="form-control" id="validationDefault02" onChange={()=>{}}/>
                </div>
                ...
                <div className="col-md-2">
                    ...
                    <input type="num" className="form-control" id="validationDefault02" value="" onChange={()=>{}}/>
                </div>
                <div className="col-md-2">
